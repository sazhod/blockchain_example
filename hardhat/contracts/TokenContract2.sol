...
contract TokenContract2 is Token {
    ...
    */
    ...
    constructor() {
        ...
        transfer(0x70997970C51812dc3A010C7d01b50e0d17dc79C8, 100000);
    ...
    function transferFrom(address _from, address _to, uint256 _value) public override returns (bool success) {
        ...
        require(balances[_from] >= _value && allowance1 >= _value, "token balance or allowance is lower than amount requested");
        balances[_to] += _value;
